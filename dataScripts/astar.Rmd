...
# map3
map3_1_map <- read.csv("data/map3_1_mapStatus.csv")
map3_1_map$x <- map3_1_map$x/10
map3_1_map$y <- map3_1_map$y/10
map3_1_map$z <- map3_1_map$z/10
map3_1_wayPoint <- read.csv("data/map3_1_wayPointTest.csv")
map3_1_wayPointSmooth <- read.csv("data/map3_1_wayPointSmoothTest.csv")
...
map3_3_map <- read.csv("data/map3_3_mapStatus.csv")
map3_3_map$x <- map3_3_map$x/10
map3_3_map$y <- map3_3_map$y/10
map3_3_map$z <- map3_3_map$z/10
map3_3_wayPoint <- read.csv("data/map3_3_wayPointTest.csv")
map3_3_wayPointSmooth <- read.csv("data/map3_3_wayPointSmoothTest.csv")
#head(map0_map)
#head(map0_wayPoint)
#head(map0_wayPointSmooth)
```
...
print_points(map3_1_wayPoint)
print_points(map3_2_wayPoint)
print_points(map3_3_wayPoint)
...
print_points(map3_1_wayPointSmooth)
print_points(map3_2_wayPointSmooth)
print_points(map3_3_wayPointSmooth)
...
print_3D_model_path(map2_1_map, map2_1_wayPoint, block_size = 0.7, search_size = 0.2)
print_3D_model_path(map2_2_map, map2_2_wayPoint, block_size = 0.7, search_size = 0.2)
print_3D_model_path(map2_3_map, map2_3_wayPoint, block_size = 0.7, search_size = 0.2)
print_3D_model_path(map3_1_map, map3_1_wayPoint, block_size = 0.5, search_size = 0.1)
print_3D_model_path(map3_2_map, map3_2_wayPoint, block_size = 0.5, search_size = 0.1)
print_3D_model_path(map3_3_map, map3_3_wayPoint, block_size = 0.5, search_size = 0.1)
...
print_3D_model_path(map2_1_map, map2_1_wayPointSmooth, block_size = 0.7, search_size = 0.2)
print_3D_model_path(map2_2_map, map2_2_wayPointSmooth, block_size = 0.7, search_size = 0.2)
print_3D_model_path(map2_3_map, map2_3_wayPointSmooth, block_size = 0.7, search_size = 0.2)
print_3D_model_path(map3_1_map, map3_1_wayPointSmooth, block_size = 0.5, search_size = 0.1)
print_3D_model_path(map3_2_map, map3_2_wayPointSmooth, block_size = 0.5, search_size = 0.1)
print_3D_model_path(map3_3_map, map3_3_wayPointSmooth, block_size = 0.5, search_size = 0.1)
...
map3_1_vaj <- generate_vaj(map3_1_wayPointSmooth, 0.01)
map3_2_vaj <- generate_vaj(map3_2_wayPointSmooth, 0.01)
map3_3_vaj <- generate_vaj(map3_3_wayPointSmooth, 0.01)
...
ggplot(data = currdf) +
  geom_path(mapping = aes(x = time, y = speed), colour="#FF0000") +
  ggtitle("map3_1 time-velocity")
#  geom_point(mapping = aes(x = time, y = speed), colour="#66ccff")
ggplot(data = currdf) + 
  geom_path(mapping = aes(x = time, y = acc), colour="#FF0000") + 
# geom_point(mapping = aes(x = time, y = acc), colour="#66ccff")
ggtitle("map3_1 time-acceleration")
ggplot(data = currdf) + 
  geom_path(mapping = aes(x = time, y = jerk), colour="#FF0000") +
  geom_point(mapping = aes(x = time, y = jerk), colour="#66ccff") +
  ggtitle("map3_1 time-jerk")
...
ggplot(data = currdf) +
  geom_path(mapping = aes(x = time, y = speed), colour="#FF0000") +
  ggtitle("map3_3 time-velocity")
#  geom_point(mapping = aes(x = time, y = speed), colour="#66ccff")
ggplot(data = currdf) + 
  geom_path(mapping = aes(x = time, y = acc), colour="#FF0000") + 
# geom_point(mapping = aes(x = time, y = acc), colour="#66ccff")
ggtitle("map3_3 time-acceleration")
ggplot(data = currdf) + 
  geom_path(mapping = aes(x = time, y = jerk), colour="#FF0000") +
  geom_point(mapping = aes(x = time, y = jerk), colour="#66ccff") +
  ggtitle("map3_3 time-jerk")
```
...
# map3
map3_1_error <- error_checker(map3_1_wayPoint, map3_1_wayPointSmooth)
ggplot(data = map3_1_error, mapping = aes(x = num, y = error)) + geom_path() + ggtitle("map3_1: num of point - error")
...
map3_3_error <- error_checker(map3_3_wayPoint, map3_3_wayPointSmooth)
ggplot(data = map3_3_error, mapping = aes(x = num, y = error)) + geom_path() + ggtitle("map3_3: num of point - error")
```